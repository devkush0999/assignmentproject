...
const DropdownComponent = () => {
  ...
  return (
    <View className="flex items-start">
      <View className="flex-row justify-between gap-[50px]">
        <TouchableOpacity
          onPress={toggleDropdown}
          className="flex-row gap-12 items-center px-2 w-[220px] h-[36px] py-2 bg-gray-50 rounded-[15px] border border-gray-200"
        >
        ...
        <TouchableOpacity
          onPress={toggleDropdown}
          className="flex-row items-center my-3 h-[20px] w-[125px] m-2 "
        >
